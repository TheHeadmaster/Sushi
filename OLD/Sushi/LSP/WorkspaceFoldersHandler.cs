...
public sealed class WorkspaceFoldersHandler(ILanguageServerFacade facade, SushiLanguageService sushi) : DidChangeWorkspaceFoldersHandlerBase
{
    ...
    {
        await sushi.UpdateWorkspaceFolders(facade, [.. request.Event.Added], [.. request.Event.Removed]);
