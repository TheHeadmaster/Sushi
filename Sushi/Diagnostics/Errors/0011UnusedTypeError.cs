...
/// The variable name.
/// </param>
public sealed class UnusedTypeError([NotNull] Token startToken, string name) : CompilerMessage(startToken.CurrentLine, startToken.LineNumber, startToken.LinePosition)
{
    /// <inheritdoc />
