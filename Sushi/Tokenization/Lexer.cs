...
public static partial class Lexer
{
    ...
    /// </returns>
    public static async Task<List<TokenFile>> LexFiles([NotNull] string projectPath) => await Diag.MonitorAsync("Lexing", async () =>
    {
    ...
    /// </returns>
    public static async Task<TokenFile> LexFile([NotNull] string sourceFilePath)
    {
